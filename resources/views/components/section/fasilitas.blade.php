<div class="max-w-7xl mx-auto p-5 md:p-10 gap-5">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 items-center gap-6 lg:gap-10">
        <!-- Card -->
        <div
            class="w-full h-full bg-white shadow-lg hover:shadow-md transition-all duration-200 ease-in-out border-2 rounded-lg py-5 md:py-8 dark:bg-slate-900">
            <div class="flex flex-col items-center justify-center gap-y-4">
                <div
                    ...
                    <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" width="16"
